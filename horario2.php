...
function lanzarSubmenu1(){ 
   window.open("imprimirhorario.php?idu=<?php echo $nhorario;?>","ventana1","width=830,height=500,scrollbars=YES") 
} 
</script>
<script language="JavaScript">
<!--
...
?>
  ...
  <tr>
    <td valign="top"><div align="center">
      <p class="Estilo52">Horarios<span class="Estilo64">
        <?php
...
$sql = "insert into horario (cuatrimestre, cohorte, asignatura, mes, jueves, viernes, sabado, hora, nhorario, periodo, observacion, mencion) values ('$cuatrimestre', '$cohorte', '$materia', '$mes', '$jueves', '$viernes', '$sabado', '$horario', '$nhorario', '$periodo', '$observacion', '$mencion');";
        ...
        <table width="534" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#666666">
          ...
          <tr>
            ...
            <td width="220" bordercolor="#6A90B5" bgcolor="#FFFFFF"><span class="Estilo54"><strong>Cohorte:<span class="Estilo11">
                <input name="nhorario" type="hidden" id="nhorario" value="<? echo $nhorario; ?>">
                  </span></strong></span></td>
          </tr>
          <tr>
            <td bordercolor="#6A90B5" bgcolor="#FFFFFF"><span class="Estilo54">
              <input name="periodo" type="text" class="Estilo53" id="periodo" value="<? echo $periodo; ?>" size="12" maxlength="8" placeholder="Indique el Periodo">
...
<?=$ligne["cohorte"]; ?>
	...
	$nro_fila++;
        ...
        <p><strong>
          <label onClick="lanzarSubmenu1()"><a href="horario.php">FIN DE HORARIO </a></label>
        </strong></p>
      </form>
      </div></td>
