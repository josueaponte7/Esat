...
$pdf->SetAuthor('ESAT');
$pdf->SetTitle('Reporte de Asignaturas');
$pdf->SetSubject('Reporte de Asignaturas');
$pdf->SetKeywords('asignaturas, reporte, esat');
...
<h1 class="title">Reporte de Facilitadores</h1>
...
$pdf->Output('reporte-asignaturas.pdf', 'I');
