...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="top"><div align="center">
      <p class="Estilo52">Cambio de Clave </p>
      <form action="cambioclave.php" method="post" name="form1" id="form1" onSubmit="return Validar(this);">
        <table width="368" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#666666">

          <tr>
            <td bordercolor="#6A90B5" bgcolor="#FFFFFF"><span class="Estilo54"><strong>Usuario:</strong></span></td>
          </tr>
          <tr>
            <td bordercolor="#6A90B5" bgcolor="#FFFFFF"><span class="Estilo54">
              <input name="usuario2" type="text" class="Estilo53" id="usuario2" value="<?php echo $_SESSION["usuario"]; ?>" size="45" placeholder="Introduzca el Usuario">
              <span class="Estilo6">*</span></span></td>
          </tr>
          <tr>
            <td bordercolor="#6A90B5" bgcolor="#FFFFFF"><span class="Estilo54"><strong>Nueva Clave:</strong></span></td>
          </tr>
          <tr>
            <td bordercolor="#6A90B5" bgcolor="#FFFFFF"><span class="Estilo54">
              <input name="claveee" type="password" class="Estilo53" id="claveee" size="45" placeholder="Introduzca la contrase&ntilde;a">
              <span class="Estilo6">*</span></span></td>
          </tr>
