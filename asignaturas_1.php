                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group" style="margin-bottom: 12px;">
                                                <label for="exampleInputEmail1">Especialidad/Menci&oacute;n: </label>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group" style="margin-bottom: 12px;">
                                                ...
                                                <input name="codigo" type="text" class="form-control input-sm" id="codigo" maxlength="15" placeholder="Ingrese Codigo">
                                            </div>
                                        </td>
                                        <td>
                                            <span class="Estilo6" style="margin-left: 5px;">*</span>
                                        ...
                                        <td>
                                            <div class="form-group" style="margin-bottom: 12px;">
                                                ...
                                                <select name="cuatrimestre" id="cuatrimestre" class="form-control input-sm">
                                                    ...
                                                    <option value="COMPLEMENTOS ACADÉMICOS">COMPLEMENTOS ACADÉMICOS</option>
                                                </select>                                            
                                            </div>
                                        </td>
                                        <td>
