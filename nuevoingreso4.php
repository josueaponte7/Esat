...
$operacion= "Inscribio una materia de nuevo ingreso";
...
?>
  ...
  <tr>
    <td valign="top"><div align="center">
      <p class="Estilo52">Inscripci&oacute;n de Nuevo Ingreso <span class="Estilo51">
 ...
 ?>
          ...
          <tr>
            <td bordercolor="#6A90B5" bgcolor="#FFFFFF"><span class="Estilo54">
              <input name="cedula_par" type="text" class="Estilo53" id="cedula_par" onKeyPress="return acceptNum(event)" value="<?php echo $ligne3["cedula_par"]; 
 ...
 ?>
          ...
          <tr>
            <td colspan="3" bordercolor="#6A90B5" bgcolor="#FFFFFF"><strong>Cohorte: <span class="Estilo54">
              <input name="cohorte" type="text" class="Estilo53" id="cohorte" value="<?php echo $ligne3["cohorte"]; ?>" size="20" placeholder="Introduzca la Cohorte">
          ...
          <tr>
            <td colspan="3" bordercolor="#6A90B5" bgcolor="#FFFFFF"><strong>Doctorado: <span class="Estilo54">
              <input name="mencion" type="text" class="Estilo53" id="mencion" value="<?php echo $ligne3["doctorado"]; ?>" size="50" placeholder="Introduzca la Cohorte">
            </span></strong></td>
          </tr>
          <tr>
...
// $nro_fila2= @mysql_num_rows ($res2);
 ...
 ?>
              ...
              <input name="cuatrimestre" type="text" class="Estilo53" id="cuatrimestre" value="<?php echo $ligne5["cuatrimestre"]; ?>" size="20" placeholder="Introduzca el Nombre">
              <span class="Estilo6">*</span></span></td>
          </tr>
          <tr>
...
$cedula_par=$cedula_par;
 ...
 ?>
			  ...
			  $cuatrimestre=$ligne["cuatrimestre"]; ?>
                    ...
                    <td><a href="eliminarmat.php?id=<?php echo $ligne['id']?>"onclick="return confirm('<?php echo $_SESSION["usuario"];?> Estas seguro que deseas eliminar?')">
                            <img src="images/eliminar.jpg" width="29" height="29" border="0">
                        </a>
