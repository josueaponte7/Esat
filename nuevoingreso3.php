...
?>
  ...
  <tr>
    <td valign="top"><div align="center">
      ...
      </span><span class="Estilo51"><span class="Estilo59">
      <span class="Estilo64">
      <?php

$query="SELECT * FROM detalle_inscripcion WHERE codigo_materia='$codigo_materia' and ninscripcion='$ninscripcion'";
$result8=@mysql_query($query);
$array8=@mysql_fetch_array($result8);
if(mysql_num_rows($result8)<>0){
?>
      <script language="JavaScript">
alert("Disculpe ya este materia se encuentra agregada.");
location.href="nuevoingreso4.php"
        </script>
      <?php
}
else
...
$sql = "insert into detalle_inscripcion (cedula_par, cohorte, codigo_materia, cuatrimestre, ninscripcion) values ('$cedula_par', '$cohorte', '$codigo_materia', '$cuatrimestre', '$ninscripcion');";
...
// include("conexion44.php");
 ...
 ?>
			  ...
			  $cuatrimestre=$ligne["cuatrimestre"]; ?>
                    ...
                    <td><a href="eliminarmat.php?id=<?php echo $ligne['id']?>"onclick="return confirm('<?php echo  $_SESSION["usuario"];?> Estas seguro que deseas eliminar?')"><img src="images/eliminar.jpg" width="29" height="29" border="0"></a><a href="eliminarfactura.php?id=<?php echo $fila['id']?>"></a></td>
                  </tr>
                  <?php
	$nro_fila++;
 } ?>
