...
$operacion= "Ingreso a Constancia de Estudio";
...
?>
  ...
  <tr>
    <td valign="top"><div align="center">
      <p class="Estilo52">Constancia de Notas </p>
      <form action="imprimirnotas2.php" method="post" name="form1" target="_blank" id="form1" onSubmit="return Validar(this);">
        <table width="534" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#666666">
          ...
          <tr>
            <td colspan="3" bordercolor="#6A90B5" bgcolor="#FFFFFF"><strong>Cuatrimestre:</strong><span class="Estilo6">
