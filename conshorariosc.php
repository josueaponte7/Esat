...
$cohorte=$_REQUEST["cohorte"];
   ...
   $query="SELECT * from horario where cohorte='$cohorte' order by nhorario";
   $resultado=mysql_query($query);
?>
<? mysql_connect("localhost","root","admin");
   mysql_select_db("esat");
   $_pagi_sql="SELECT * from horario where cohorte='$cohorte' order by nhorario";
...
?>
      ...
      <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
        ...
        <tr>
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th scope="col"><a href="editarasignaturas.php?cod_asi=<?=$fila['cod_asi']?>"></a><a href="eliminarhorario.php?id=<?=$fila['id']?>"onclick="return confirm('¿<? echo $_SESSION["usuario"];?> Estás seguro que deseas eliminar?')"><img src="images/Eliminar.jpg" width="36" height="36" border="0" title="Eliminar"></a></th>
                </tr>
          </table></td>
        </tr>
        <? }?>
      ...
      <p><a href="horariospdf.php" target="_blank"><img src="images/descarga.jpg" width="48" height="48" border="0" title="Imprimir en PDF"></a></p>
    </div></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
