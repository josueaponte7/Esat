...
$mencion=$_REQUEST["mencion"];
   ...
   $query="SELECT * from inscripcion where doctorado='$mencion' group by cedula_par";
   $resultado=mysql_query($query);
?>
<? mysql_connect("localhost","root","admin");
   mysql_select_db("esat");
   $_pagi_sql="SELECT * from inscripcion where doctorado='$mencion' group by cedula_par";
