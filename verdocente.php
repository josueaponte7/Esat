...
require './conex.php';
conectar();
$query="SELECT * FROM facilitadores";
...
<?php
   ...
   $_pagi_sql="SELECT * from facilitadores order by cedula asc";
...
function pon_prefijo(cedula,nombre,apellido) {
    parent.opener.document.form1.cedula_fac.value=cedula;
...
$sql="SELECT * FROM facilitadores order by cedula asc";
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="1231" align="right" valign="top"><form name="form1" method="post" action="verinsumo1.php">
                      <label>
                      <div align="center"><span class="Estilo113">LISTA DE FACILITADORES </span></div>
                      </label>
                  </form></td>
                </tr>
              </table>
...
while($rows=mysql_fetch_array($_pagi_result)){ ?>
                        <tr>
                          ...
                          <td align="center">
                              <a href="javascript:pon_prefijo('<?php echo $rows['cedula']; ?>','<?php echo $rows['nombre']?>','<?php echo $rows['apellido']?>')" title="Seleccionar Facilitador" class="Estilo121">
