...
?>
  ...
  <tr>
    <td valign="top"><div align="center">
      <p class="Estilo52">Constancia de Estudio </p>
      <form action="imprimirconstancia2.php" method="post" name="form1" target="_blank" id="form1" onSubmit="return Validar(this);">
        <table width="228" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#666666">
          ...
          <tr>
            <td bordercolor="#6A90B5" bgcolor="#FFFFFF"><span class="Estilo54">
              ...
              <div align="left" class="Estilo54"><strong>Indique C.I. del Participante: </strong></div>        
