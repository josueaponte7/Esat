...
$operacion= "Ingreso al Registro de Cuatrimestre";
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="top"><div align="center">
            <p class="Estilo52">Registrar Cuatrimestre </p>
      <form action="cuatrimestrereg.php" method="post" name="form1" id="form1" onSubmit="return Validar(this);">
        <table width="368" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#666666">
          ...
          <tr>
            <td bordercolor="#6A90B5" bgcolor="#FFFFFF"><span class="Estilo54">
              <input name="cuatrimestre" type="text" class="Estilo53" id="cuatrimestre" value="" size="45" placeholder="Nombre Cuatrimestre">
