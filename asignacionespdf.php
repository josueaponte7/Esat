...
<p align="center"><span class="Estilo52">Reporte de Asignaciones de Asignatura </span><span class="Estilo55">
  <?php
...
// $nro_fila2= @mysql_num_rows ($res2);
 ...
 {
 ?>
  <?  $ligne4["nombre"]; ?> <?  $ligne4["apellido"]; ?></span><strong>
  <?php } ?>
</strong></p>
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    <td width="145"><div align="center"><strong>C.I.</strong></div></td>
    <td width="313"><div align="center"><span class="Estilo53">Nombre y Apellido </span></div></td>
    <td width="285"><div align="center"><span class="Estilo53">Tel&eacute;fonos</span></div></td>
    <td width="272"><div align="center"><span class="Estilo53">C&oacute;digo</span></div></td>
    <td width="364"><div align="center"><strong>Asignatura</strong></div></td>
  </tr>
...
// $nro_fila2= @mysql_num_rows ($res2);
 ...
 {
 ?>
      <? echo $ligne4["nombre"]; ?> <? echo $ligne4["apellido"]; ?></span> </span></span></td>
    <td><span class="Estilo54"><span class="Estilo55"><? echo $ligne4["telefono"]; ?></span><span class="Estilo11"><span class="Estilo55"><strong>
      <?php } ?>
