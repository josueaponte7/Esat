...
function pon_prefijo(codigo,nombre,mencion) {
	...
	parent.opener.document.form1.mencion.value=mencion;
	parent.window.close();
}
        ...
        <tr>
          <th scope="row"><div align="justify" class="Estilo106">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="1231" align="right" valign="top">
                      <form name="form1" method="post" action="verinsumo1.php">
                      <label>
                ...
                <tr>
                  <th scope="row"><form name="form2" method="post" action="" onSubmit="return Valida()">
                      <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" bgcolor="#FFFFFF">
                        <tr bgcolor="#1D78AF">
                          <td width="199" height="22" align="center" bgcolor="#AA0000"><span class="Estilo116">C&oacute;digo</span></td>
                          <td width="523" align="center" bgcolor="#AA0000"><span class="Estilo116">Nombre</span></td>
                          <td width="234" align="center" bgcolor="#AA0000"><span class="Estilo122">Menci&oacute;n</span></td>
                          <td width="186" align="center" bgcolor="#AA0000"><span class="Estilo122">Cuatrimestre</span></td>
                          <td width="126" align="center" bgcolor="#AA0000"><span class="Estilo122">Tipo</span></td>
                          <td width="90" align="center" bgcolor="#AA0000"><span class="Estilo118">Acci&oacute;n</span></td>
                        </tr>
                        <?php
while($rows=mysql_fetch_array($_pagi_result)){ ?>
                        <tr>
                          ...
                          <td align="center"><a href="javascript:pon_prefijo('<? echo $rows['codigo']; ?>','<?=$rows['nombre']?>','<?=$rows['mencion']?>')" title="Seleccionar Materia" class="Estilo121"><img src="images/ok.jpg" width="23" height="23" border="0"></a></td>
                        </tr>
                        <? }?>
                      </table>
                  </form></th>
            ...
            <div align="center"><span class="Estilo10"><? echo $_pagi_navegacion ?></span></div>
          </div></th>
        </tr>
      </table></th>
    </tr>
