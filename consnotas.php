...
?>
 ...
 ?>
      ...
      <form action="consnotas2.php" method="post" name="form2" id="form2">
...
// $nro_fila2= @mysql_num_rows ($res2);
 ...
 //var_dump($ligne); 
 {
 ?><?php echo $ligne4["apellido"]; ?></span>          <span class="Estilo55"> <?php echo $ligne4["nombre"]; ?><strong>
            <?php } ?>
            </strong></span></span></td>
          ...
          <td><span class="Estilo54">
            <?php echo $fila['facilitador'];
			$facilitador=$fila['facilitador']; ?>
          </span></td>
          <td><span class="Estilo54">
            <?php echo $fila['notaauto'];
      ...
      <p>
          <a href="notaspdf.php" target="_blank">
